              ...
              <div class="box box-widget widget-user"><br>
					  ...
					  <div class="row">
						<div class="col-sm-4">
						  <div class="description-block">
							<h5 class="description-header text-success"><strong>Name :</strong>    </h5>
						...
						<div class="col-sm-4 br-1 bl-1">
						  <div class="description-block">
							<h5 class="description-header text-success">Mobile : </h5>
						...
						<div class="col-sm-4">
						  <div class="description-block">
							<h5 class="description-header text-success">Gender : </h5>
                    ...
                    <div class="box-footer">
					  <div class="row">
						<div class="col-sm-4">
						  <div class="description-block">
							<h5 class="description-header text-success">Address : </h5>
						...
						<div class="col-sm-4 br-1 bl-1">
						  <div class="description-block">
							<h5 class="description-header text-success">Email : </h5>
