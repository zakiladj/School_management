				 ...
				 <a href="index.html">
				  <!-- logo for regular state and mobile devices -->
					 <div class="d-flex align-items-center justify-content-center">
						  ...
						  <img src="{{ asset('backend/images/logo-light.png') }}" alt="Logo EasyClass">
						  <h3><b>EasyClass +</b> Admin</h3>
					 </div>
				</a>
			</div>
        </div>
      ...
      {{-- User Section  --}}
        <li class="treeview {{ ($prefix == '/users')?'active':'' }} "   >
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('user.view') }}"><i data-feather="eye"></i> View Users</a></li>
            <li><a href="{{ route('user.create') }}"><i data-feather="plus"></i> Add User</a></li>
          </ul>
        </li>
        {{-- Manger Section  --}}
         <li class="treeview {{ ($prefix == '/profile')?'active':'' }} " >
            ...
            <ul class="treeview-menu">
                <li><a href="{{ route('profile.view') }}"><i data-feather="info"></i> View Profile</a></li>
                <li><a href="{{ route('password.view') }}"><i data-feather="lock"></i> Change Password</a></li>
            </ul>
        </li>
